...
<head>
<meta charset="UTF-8">
<title>Non-Fiction Books - Online Ebook Store</title>
...
<body style="background-color: #f5f5f5;">
    ...
    <div class="container-fluid p-5">
        <h2 class="section-title">📖 Non-Fiction Books</h2>
        <p class="text-center text-muted mb-5">Discover real stories and factual information</p>
        ...
        <div class="row">
            ...
            try {
                ...
                List<BookDtls> list = dao.getNonFictionBook();
                if (list.isEmpty()) {
            %>
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> No non-fiction books available at the moment.
                    </div>
                </div>
            <%
                } else {

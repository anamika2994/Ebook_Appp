...
<head>
<meta charset="UTF-8">
<title>Fiction Books - Online Ebook Store</title>
...
<body style="background-color: #f5f5f5;">
    ...
    <div class="container-fluid p-5">
        ...
        <p class="text-center text-muted mb-5">Explore our collection of imaginative fiction stories</p>
        ...
        <div class="row">
            ...
            try {
                ...
                List<BookDtls> list = dao.getAllFictionBook();
                if (list.isEmpty()) {
            %>
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> No fiction books available at the moment.
                    </div>
                </div>
            <%
                } else {

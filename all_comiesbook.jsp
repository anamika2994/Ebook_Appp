...
<head>
<meta charset="UTF-8">
<title>Comics Books - Online Ebook Store</title>
...
<body style="background-color: #f5f5f5;">
    ...
    <div class="container-fluid p-5">
        <h2 class="section-title">🦸 Comics & Graphic Novels</h2>
        <p class="text-center text-muted mb-5">Dive into the world of visual storytelling</p>
        ...
        <div class="row">
            ...
            try {
                ...
                List<BookDtls> list = dao.getComicsBook();
                if (list.isEmpty()) {
            %>
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> No comics books available at the moment.
                    </div>
                </div>
            <%
                } else {

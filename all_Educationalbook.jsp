...
<head>
<meta charset="UTF-8">
<title>Educational Books - Online Ebook Store</title>
...
<body style="background-color: #f5f5f5;">
    ...
    <div class="container-fluid p-5">
        <h2 class="section-title">🎓 Educational Books</h2>
        <p class="text-center text-muted mb-5">Expand your knowledge with educational resources</p>
        ...
        <div class="row">
            ...
            try {
                ...
                List<BookDtls> list = dao.getEducationalBook();
                if (list.isEmpty()) {
            %>
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> No educational books available at the moment.
                    </div>
                </div>
            <%
                } else {
